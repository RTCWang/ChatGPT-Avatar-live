...
public class Texture2dProgram {
    ...
    public enum ProgramType {
        TEXTURE_2D, TEXTURE_EXT, TEXTURE_EXT_BW, TEXTURE_EXT_FILT, TEXTURE_2D_BG,
    }
    ...
    private static final String FRAGMENT_SHADER_2D_BG =
            "#version 100\n" +
            "precision highp float;\n"+
            "precision mediump float;\n" +
            "uniform vec4 uColor;\n" +
...
//            "    src.r = LinearToGammaSpaceExact(src.r);\n" +
//            "    src.g = LinearToGammaSpaceExact(src.g);\n" +
//            "    src.b = LinearToGammaSpaceExact(src.b);\n" +
            "    gl_FragColor = src * src.a + uColor * (1.0 - src.a);\n" +
            "}\n";
    ...
    public Texture2dProgram(ProgramType programType) {
        ...
        switch (programType) {
            ...
            case TEXTURE_2D_BG:
                mTextureTarget = GLES20.GL_TEXTURE_2D;
                mProgramHandle = GlUtil.createProgram(VERTEX_SHADER, FRAGMENT_SHADER_2D_BG);
                break;
            case TEXTURE_EXT:
